...
import { 
  Menu, X, User, LogOut, Bell, ChevronDown, Search, Sun, Moon,
  BookOpen, Calendar, GraduationCap, FileText, Clock, 
  MessageSquare, CreditCard, Award, HelpCircle
} from 'lucide-react';
...
export default function StudentNavbar() {
  ...
  // Mock notifications relevant to students
  const notifications = [
    { id: 1, text: 'New assignment in Advanced Mathematics', time: '10 minutes ago', read: false },
    { id: 2, text: 'Grade posted for Computer Science midterm', time: '1 hour ago', read: false },
    { id: 3, text: 'Registration for next semester opens tomorrow', time: '2 hours ago', read: true },
    { id: 4, text: 'Reminder: Physics lab report due tonight', time: '5 hours ago', read: true }
  ];
    ...
    <nav className="border-b border-gray-200 bg-white shadow-sm">
      <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 justify-between">
          ...
          {/* Search */}
          <div className="hidden lg:flex lg:flex-1 lg:justify-center px-2 max-w-lg">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex">
              <Link
                to="/student/payments"
                className="ml-2 rounded-full p-1 text-gray-600 hover:bg-gray-100 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                title="Payments"
              >
              ...
              {notificationsOpen && (
                <div className="absolute right-0 mt-2 w-80 origin-top-right rounded-md bg-white p-2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  ...
                  <div className="border-t border-gray-200 pt-2">
                    <Link to="/student/notifications" className="block text-center text-xs font-medium text-blue-600 hover:text-blue-500">
            ...
            <div className="relative ml-3" ref={profileMenuRef}>
              ...
              >
                ...
                <span className="ml-2 hidden text-gray-700 lg:block">{user?.username || 'Student'}</span>
              ...
              {profileMenuOpen && (
                <div className="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <div className="border-b border-gray-100 px-4 py-2">
                    <p className="text-sm font-medium text-gray-800">{user?.username || 'Student'}</p>
        ...
        <div className="md:hidden">
          <div className="space-y-1 border-t border-gray-200 px-2 pb-3 pt-2">
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
            >
              <Clock className="mr-3 h-5 w-5 flex-shrink-0" aria-hidden="true" />
              Deadlines
              <span className="ml-auto rounded-full bg-yellow-500 px-2 py-0.5 text-xs font-medium text-white">2</span>
            </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
            >
              <HelpCircle className="mr-3 h-5 w-5 flex-shrink-0" aria-hidden="true" />
              Help & Support
            </Link>
          </div>
        </div>
